...
from src.core import commander_data, url_utils
from src.core.scryfall_integration import ScryfallAPI
...
class CommanderService:
    ...
    def get_csv_info(self):
        ...
        for period, csv_file in self.csv_files.items():
            try:
                commanders = commander_data.load_commanders(csv_file)
    ...
    def get_commander_url(self, commander_name):
        ...
        return url_utils.commander_name_to_url(commander_name)
